...
<div class="container">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <p><strong>Tanggal:</strong> {{ $stockIn->tanggal_masuk }}</p>
                    <p><strong>Petugas:</strong> {{ $stockIn->user->nama ?? '-' }}</p>
                    <p><strong>Keterangan:</strong> {{ $stockIn->keterangan ?? '-' }}</p>
                </div>
            </div>

            <h4>Barang yang Masuk:</h4>
